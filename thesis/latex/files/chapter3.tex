...
Regarding the Function Calling approach, all services utilized in the workflow definition were made available to the model through the Spring AI function calling implementation.
